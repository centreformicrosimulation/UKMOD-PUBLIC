...
***************************************************************************************
dir "${origydata}/*.dta"
foreach f in accounts adult assets benefits benunit care child chldcare endowmnt extchild frs2425 govpay househol job maint mortcont mortgage oddjob owner penprov pension rentcont renter   {
